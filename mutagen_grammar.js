...
", 
               {hug: hug,
                int: parseInt,
                mkChoice : function(pairs) { return Weighted(dict(pairs)) }, // XXX *pairs
                mkEmpty  : function() { return null; },
                mkFixed  : function (tag, pairs) { return Fixed(tag, Weighted(dict(pairs))) }, // XXX
                mkLiteral: function(s) { return s; },
                mkPunct  : mkPunct,
                mkRef    : function(name) { return delay(function() { return rules[name]; }); }, // XXX
                mkSeq    : Sequence,
                mkShuffle: function(pairs) { return Shuffle(dict(pairs)); }, // XXX
